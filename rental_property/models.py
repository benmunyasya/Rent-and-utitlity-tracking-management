...
class UnitAlbum(models.Model):
    ...
    image = models.ImageField(upload_to=get_house_album_path, width_field='image_width', height_field='image_height',null=True,blank=True)
    image_width = models.IntegerField(default=600,null=True,blank=True)
